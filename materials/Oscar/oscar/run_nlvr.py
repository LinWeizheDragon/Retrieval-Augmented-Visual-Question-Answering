...
from transformers2.pytorch_transformers import (WEIGHTS_NAME, BertConfig, BertTokenizer)
from transformers2.pytorch_transformers import AdamW, WarmupLinearSchedule
