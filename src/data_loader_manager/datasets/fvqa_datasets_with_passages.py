...
from data_loader_manager.datasets.fvqa_datasets import FVQADataset


class FVQADatasetWithRandomPickPassages(FVQADataset, ModuleParser):
    """
    This is a dataset class for FVQA dataset with randomly picked passage inputs
...
class FVQADatasetWithBatchPassages(FVQADataset, ModuleParser):
    """
    This is a dataset class for FVQA dataset with batched passage inputs
...
class FVQADatasetWithAllPassages(FVQADataset, ModuleParser):
    """
    This is a dataset class for FVQA dataset with all passage inputs
    query + [passsages] will be transformed into [query + passage1, query + passage2, ...]
